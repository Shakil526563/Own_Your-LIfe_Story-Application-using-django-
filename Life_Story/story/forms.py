...
from .models import Profile, BlogPost,storyPost
...
class BlogPostForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'title': forms.TextInput(attrs={'class':'form-control', 'placeholder':'Blog Titile'}),
...
class BlogPostForm1(forms.ModelForm):
    class Meta:
        model = storyPost
        fields = ('title', 'slug', 'content', 'image')
        widgets = {
